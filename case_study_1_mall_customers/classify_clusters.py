...
# reloading and recreating the clustering here so this file can run on its own
...
# now treating the cluster labels as the target for classification
y = df['Cluster']
...
# saving whichever model performed better, along with the scaler for reuse
